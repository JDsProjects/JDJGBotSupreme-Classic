...
class UserCodes:
    ...
    data_code_types = [
        DataCode("Super Smash Bros.", ["SSBU", "SSB", "Super Smash Bros", "Super Smash Bros Ultimate"]),
        DataCode(
            "Super Mario Maker",
            [
                "SMM",
        ...
        DataCode(
            "Super Mario Odyssey", ["Mario Odyssey", "SMO", "Luigis Baloon World", "Baloon", "Luigi's Balon World"]
        ),
    ]
