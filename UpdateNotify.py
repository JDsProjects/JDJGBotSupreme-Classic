    ...
    if mode == "[send]":
        ...
        try:
            ...
            await message.author.dm_channel.send(
                "There is no channel specified to send this update message to! Please define what channel you would like to send updates to with 'JDBot*update set' in the channel that you would like to send messages to"
            )
