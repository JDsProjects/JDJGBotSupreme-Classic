...
class Dice(commands.Cog):
    ...
    async def dice_roll20(self, ctx):
        embed_message = discord.Embed(
            title=f" Rolled a {random.randint(1,20)}",
    ...
    async def dice_roll6(self, ctx):
        embed_message = discord.Embed(
            title=f" Rolled a {random.randint(1,6)}",
            color=random.randint(0, 16777215),
            timestamp=(ctx.message.created_at),
        )
        embed_message.set_footer(text=f"{ctx.author.id}")
        embed_message.set_thumbnail(url="https://i.imgur.com/AivZBWP.png")
        embed_message.set_author(name=f"d6 Rolled by {ctx.author}:", icon_url=(ctx.author.display_avatar.url))
    ...
    async def dice_roll10(self, ctx):
        embed_message = discord.Embed(
            title=f" Rolled a {random.randint(1,10)}",
            color=random.randint(0, 16777215),
            timestamp=(ctx.message.created_at),
        )
        embed_message.set_footer(text=f"{ctx.author.id}")
        embed_message.set_thumbnail(url="https://i.imgur.com/AivZBWP.png")
        embed_message.set_author(name=f"d10 Rolled by {ctx.author}:", icon_url=(ctx.author.display_avatar.url))
    ...
    async def dice_roll100(self, ctx):
        embed_message = discord.Embed(
            title=f" Rolled a {random.randint(1,100)}",
            color=random.randint(0, 16777215),
            timestamp=(ctx.message.created_at),
        )
        embed_message.set_footer(text=f"{ctx.author.id}")
    ...
    async def dice_roll12(self, ctx):
        embed_message = discord.Embed(
            title=f" Rolled a {random.randint(1,12)}",
            color=random.randint(0, 16777215),
            timestamp=(ctx.message.created_at),
        )
        embed_message.set_footer(text=f"{ctx.author.id}")
    ...
    async def dice_roll8(self, ctx):
        embed_message = discord.Embed(
            title=f" Rolled a {random.randint(1,8)}",
            color=random.randint(0, 16777215),
            timestamp=(ctx.message.created_at),
        )
        embed_message.set_footer(text=f"{ctx.author.id}")
    ...
    async def dice_roll4(self, ctx):
        embed_message = discord.Embed(
            title=f" Rolled a {random.randint(1,4)}",
            color=random.randint(0, 16777215),
            timestamp=(ctx.message.created_at),
        )
        embed_message.set_footer(text=f"{ctx.author.id}")
